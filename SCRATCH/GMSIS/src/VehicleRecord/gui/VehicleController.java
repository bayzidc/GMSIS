...
public class VehicleController implements Initializable {
    ...
    public void addBooking(ActionEvent event) throws IOException
    {
        ...
        obj.initiateBookingFromVehicle(table.getSelectionModel().getSelectedItem().getCustName(), table.getSelectionModel().getSelectedItem().getCustID(), table.getSelectionModel().getSelectedItem().getRegNumber(), table.getSelectionModel().getSelectedItem().getMileage());
